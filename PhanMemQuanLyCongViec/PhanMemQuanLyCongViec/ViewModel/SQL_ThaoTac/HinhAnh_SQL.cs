...
namespace PhanMemQuanLyCongViec.ViewModel.SQL_ThaoTac
{
    public class HinhAnh_SQL
    {
        ...
        public static bool suaDuLieu(HinhAnh hinh)
        {
            ...
            try
            {
                string updateQuerry = "UPDATE HINHANH SET TENHINH = N'" + hinh.TenHinh + "', NGAYGIAOHINH = N'" + hinh.NgayGiaoHinh + "',SDTKHACHGIAO = N'" + hinh.SoDienThoaiKH + "',GIAHINH =" + hinh.GiaHinh +",TIENKHACHCOC = " + hinh.GiaKhachCoc + ",GHICHU = N'" + hinh.GhiChu + "',DAXONG = " + hinh.DaXong;
